...
public class SpriteEditorSpane extends JPanel {
    ...
    public SpriteEditorSpane(int[][][] arr) throws IOException {
        setLayout(new GridBagLayout());

        BufferedImage source = FileMeneger.getArrayAsBufferedImage(arr);
...
class EditorPane extends JPanel implements Scrollable {
